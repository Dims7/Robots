...
import static AdditionalMath.Additional.*;
...
public class GameVisualizer extends JPanel {
    ...
    public GameVisualizer(Robot robot) {
        ...
        m_timer.schedule(new TimerTask() {
            @Override
            public void run() {
                RobotCondition newRobotCondition = robot.onModelUpdateEvent(m_robotPositionX, m_robotPositionY, m_robotDirection, m_targetPositionX, m_targetPositionY);
